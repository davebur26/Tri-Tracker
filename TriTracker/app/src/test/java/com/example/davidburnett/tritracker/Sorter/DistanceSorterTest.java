...
public class DistanceSorterTest {
    ...
    @Before
    public void before() {
        workout1 = new Workout(Discipline.RUN, "22/09/17", 40000, 1234);
        workout2 = new Workout(Discipline.RUN, "22/09/17", 20000, 2345);
        workout3 = new Workout(Discipline.RUN, "22/09/17", 50000, 8765);
